...
module.exports = {
    ...
    async execute(message, args, cmd, client, Discord){
        ...
        if(cmd === 'play' || cmd === 'p'){
            ...
            //message.channel.send(`:musical_note:  Started playing the song **${songs.title}**!`);
        ...
        //music.event.on('playSong', async () => {
            //messagePlay(message, songs);
        //});
        //music.event.on('addSong', async () => {
            //messageAdd(message, songs);
        //});
    }
}