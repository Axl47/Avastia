...
exports.setSoundCloudToken = exports.so_validate = exports.check_id = exports.stream_from_info = exports.getFreeClientID = exports.stream = exports.so_search = exports.soundcloud = void 0;
...
async function soundcloud(url) {
    ...
    const data = await (0, Request_1.request)(`https://api-v2.soundcloud.com/resolve?url=${url}&client_id=${soundData.client_id}`).catch((err) => err);
