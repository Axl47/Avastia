...
exports.attachListeners = exports.authorization = exports.validate = exports.stream_from_info = exports.search = exports.stream = exports.setToken = exports.getFreeClientID = exports.so_validate = exports.soundcloud = exports.is_expired = exports.refreshToken = exports.sp_validate = exports.spotify = exports.extractID = exports.yt_validate = exports.decipher_info = exports.video_info = exports.video_basic_info = exports.playlist_info = void 0;
        ...
        ask.question('Choose your service - sc (for SoundCloud) / sp (for Spotify)  / yo (for YouTube): ', (msg) => {
            if (msg.toLowerCase().startsWith('sp')) {
                ...
                ask.question('Cookies : ', (cook) => {
                    ...
                    fs_1.default.writeFileSync('.data/youtube.data', JSON.stringify({ cookie }, undefined, 4));
                    ask.close();
                });
            }
            else {
