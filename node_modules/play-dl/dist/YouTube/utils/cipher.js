...
exports.format_decipher = exports.js_tokens = void 0;
...
function download_url(format, sig) {
    ...
    const parsed_url = new url_1.URL(decoded_url);
...
async function format_decipher(formats, html5player) {
    ...
    formats.forEach((format) => {
        ...
        if (cipher) {
            Object.assign(format, querystring_1.default.parse(cipher));
