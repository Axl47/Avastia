...
function ParseSearchResult(html, options) {
    ...
    for (let i = 0; i < details.length; i++) {
        if (typeof options.limit === 'number' && options.limit > 0 && results.length === options.limit)
            break;
        if (!details[i].videoRenderer && !details[i].channelRenderer && !details[i].playlistRenderer)
            continue;
...
function parseVideo(data) {
    ...
    const res = new Video_1.YouTubeVideo({
        ...
        description: data.videoRenderer.detailedMetadataSnippets &&
...
function parsePlaylist(data) {
    ...
    const res = new Playlist_1.YouTubePlayList({
        ...
        channel: {
            id: (_a = data.playlistRenderer.shortBylineText.runs) === null || _a === void 0 ? void 0 : _a[0].navigationEndpoint.browseEndpoint.browseId,
            name: (_b = data.playlistRenderer.shortBylineText.runs) === null || _b === void 0 ? void 0 : _b[0].text,
            url: `https://www.youtube.com${(_c = data.playlistRenderer.shortBylineText.runs) === null || _c === void 0 ? void 0 : _c[0].navigationEndpoint.commandMetadata.webCommandMetadata.url}`
        },
